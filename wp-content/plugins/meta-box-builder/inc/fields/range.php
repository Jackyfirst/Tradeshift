...
<p class="description description-thin">
	<?php echo Meta_Box_Attribute::number( 'std' ); ?>
</p>

<p class="description description-thin">
	<?php echo Meta_Box_Attribute::number( 'min' ); ?>
</p>

<p class="description description-thin">
	<?php echo Meta_Box_Attribute::number( 'max' ); ?>
</p>

<p class="description description-thin">
	<?php echo Meta_Box_Attribute::number( 'step' ); ?>
</p>
