// Solutions - Apps section JS
// --------------------------------------------------------------------

// Solutions - Apps - Text rotation Powered by Typed.js
// ---------------------------------------------------
...
$(document).ready(function($){
  if ($('body').hasClass('smartling-de')){
    ...
    $('.text-carousel').typed({
      strings: ["pour aider vos employés. ^4000", "pour faire votre travail. ^4000", "de tous vos fournisseurs. ^4000", "de toute sources en ligne. ^4000", "et obtenir une visibilité complète. ^4000", "réuni en un seul endroit. ^4000"],
      loop: true
    })
    ...
    $('.text-carousel').typed({
      ...
      $('.text-carousel').typed({
      strings: ["supply chain^2000", "contracts^2000", "payments^2000", "logistics^2000", "CSR^2000", "trade finance^2000"],
      loop: true
    });
  }
});
