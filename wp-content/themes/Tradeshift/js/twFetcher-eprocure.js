 ...
 *
 * #### Tradeshift Note by @vra ####
 * Send gittip to Jason.  This rocks.
 * This plugin has been modified, specifically
 * where the DOM get's painted.  Do not update this plugin.
 * If you need a different layout, download the source, then
        ...
        H = {
            ...
            callback: function(a) {
                ...
                for (b = 0; b < e;) {
                    ...
                    d = "";
                    C ? (r && (p(a[b]), q && p(g[b])), q && (d += '<div class="user">' + w(g[b].innerHTML) + '<p class="timePosted">' + f[b].getAttribute("aria-label") + "</p>" + "</div>"), d += '<p class="tweet">' + w(a[b].innerHTML) + "</p>", v && (d = G ? d + ('<p class="timePosted"><a href="' + t[b] + '">' + f[b].getAttribute("aria-label") + "</a></p>") :
...
// ##### Fetch @Tradeshift + #procurement #####

var procurecon = {
  "id": '626826046705377280', // actual ID '626826046705377280',
  "domId": 'twStream',
  "maxTweets": 10,
  "showRetweet": false,
  "enableLinks": true,
...
twitterFetcher.fetch(procurecon);
