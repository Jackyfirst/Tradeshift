 <?php
/*
Template Name: Home Page - Video + Davos
*/
get_header('home-only'); ?>
		<!-- Main Content Starts -->
		<main class="main-content home-active-v2">
			<!-- Hero Section -->
			<div id="home-hero-b" class="hero one-supplier-video">
				<div class="video-bg">
					...
					<?php else: ?>
					<ul id="video-wrapper" class="video-bg-roll">
				...
				<div class="container">
					<div class="row cta">
						<div class="intro-text-cta">
							...
							<h3>Procurement, payables, supplier management. <br class="hidden-xs hidden-sm" />Radically nimble and connected.</h3>

							<button class="btn btn-video-track btn-secondary-cta" onclick="fn_vidyard_8qM$xEdKhaI4R8gJC_3SYw();">
								Watch our story
			...
			<div class="owl-carousel" id="carousel-announcement">
				<div class="item">
					...
					<p>Everything you need to know. <br class="visible-xs" /><a href="/resources/the-tradeshift-platform-everything-you-need-to-know/">Learn more &raquo;</a></p>
				</div>
				<div class="item">
					<img src="<?php echo get_template_directory_uri(); ?>/img/home/announce-bar-network.png" />
					<h5>Tradeshift Report</h5>
					<p>Network Application for your Supply Chain. <a href="/resources/a-network-application-platform-for-your-supply-chain/">Learn more &raquo;</a></p>
				</div>
				<div class="item">
					<img src="<?php echo get_template_directory_uri(); ?>/img/home/announce-bar-review.png" />
					<h5>Tradeshift Review</h5>
					<p>Spend Matters Reviews Tradeshift Buy. <a href="/resources/tradeshift-buy-a-deep-dive-into-tradeshifts-eprocurement-offering/">Learn more &raquo;</a></p>
				</div>
			</div>
				...
				<div class="container">
					<div class="row">
						<div class="item">
							<img src="<?php echo get_template_directory_uri(); ?>/img/home/announce-bar-ts-overview.png" />
							<h5>Tradeshift Overview</h5>
							<p>Everything you need to know. <a href="/resources/the-tradeshift-platform-everything-you-need-to-know/">Learn more &raquo;</a></p>
						</div>
						<div class="item">
							<img src="<?php echo get_template_directory_uri(); ?>/img/home/announce-bar-network.png" />
							<h5>Tradeshift Report</h5>
			...
			<div class="supplier-platform">
				<div class="container">
					<div class="row">
						<div class="contents">
							<h2 class="default-lang-container">Simplify the way you <br class="visible-xs" /><span class="text-carousel"> </span><span class="typed-cursor"> </span></h2>
							<p>Your business extends beyond your office walls. With Tradeshift, working with the trading partners and processes you care about is easy.</p>
							<p><a href="/solutions/overview/">See how &raquo;</a></p>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="row">
						<div class="contents">
							<div class="all-your-suppliers">
								...
								<h3><a href="http://tradeshift.com/supplier-onboarding/">Free for suppliers</a></h3>
								<p>Onboard fast &amp; collaborate in real time with your entire network. <br class="visible-xs" /><a href="/supplier-onboarding/">Learn more &raquo;</a></p>
							</div>
							<div class="powerful-platform">
								<a href="http://tradeshift.com/solutions/apps/"><img src="<?php echo get_template_directory_uri(); ?>/img/home/icon-platform.png" /></a>
								<h3>Powerful Apps</h3>
								<p>Respond to your growing business needs with apps on our flexible, open platform. <a href="/solutions/apps/">Learn more &raquo;</a></p>
							</div>
				...
				<div class="container">
					<div class="row">
						<div class="contents">
							...
							<p>Tradeshift is challenging the status quo of siloed software. We’re fighting for an open, connected way of doing business. Our weapon of choice? A platform that empowers everyone in the trade process and connects you to ALL your suppliers. </p>
				...
				<div class="container">
					<div class="row">
						<div class="contents">
							...
							<div class="users">
								<h3>800,000+ <br class="hidden-xs hidden-sm" />Total Users</h3>
							...
							<div class="businesses">
								<h3>Billions of Dollars in Monthly Transactions</h3>
						...
						<div class="contents">
							<div class="executives">
								<div id="executives" class="imagery">
									<div class="title-role"><h2><a href="/roles/executives">Executives</a></h2></div>
