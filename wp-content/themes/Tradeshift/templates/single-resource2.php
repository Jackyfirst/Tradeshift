<?php
/*
Template Name: Single Resources 2
*/
get_header();
?>
			...
			<div class="container">
				<div class="row">
					...
					<div class="resource-content">
						...
						<img width="650" height="350" src="https://tradeshiftchina.cn/wp-content/uploads/2019/06/Treasury_Cover_2.png" class="img-responsive wp-post-image" alt="" srcset="https://tradeshiftchina.cn/wp-content/uploads/2019/06/Treasury_Cover_2.png 650w, https://tradeshiftchina.cn/wp-content/uploads/2019/03/Treasury_Cover_2.png 250w" sizes="(max-width: 650px) 100vw, 650px" />
						<h2><?php the_title(); ?></h2>
						<?php the_content(); ?>
