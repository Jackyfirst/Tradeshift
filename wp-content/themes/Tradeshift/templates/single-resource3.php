<?php
/*
Template Name: Single Resources 3
*/
get_header();
?>
			...
			<div class="container">
				<div class="row">
					...
					<div class="resource-content">
						...
						<img width="650" height="350" src="https://tradeshiftchina.cn/wp-content/uploads/2019/08/Quick_and_Dirty_AP_cover.png" class="img-responsive wp-post-image" alt="" srcset="https://tradeshiftchina.cn/wp-content/uploads/2019/08/Quick_and_Dirty_AP_cover.png 650w, https://tradeshiftchina.cn/wp-content/uploads/2019/03/Treasury_Cover_2.png 250w" sizes="(max-width: 650px) 100vw, 650px" />
						<h2><?php the_title(); ?></h2>
						<?php the_content(); ?>
					...
					<div class="cta-form-related-material">
						...
						<div class="cta-form">
							...
							<script type="text/javascript">
									MktoForms2.loadForm("//app-sjo.marketo.com", "213-SPR-003", 6298, function(form){
										 form.vals({"Marketing_Resource_Name__c":"Quick & Dirty Guide for AP"});
								});
							</script>
						</div>
