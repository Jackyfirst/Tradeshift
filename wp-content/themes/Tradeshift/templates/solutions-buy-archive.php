			...
			<div class="hero">
				<div class="container">
					<div class="row rethink">
						<div class="contents">
							<h1>Tradeshift<sup>&reg;</sup> Buy</h1>
					...
					<div class="row freedom">
						<div class="contents">
							...
							<p id="start-kill-the-catalog-vid"><strong>It’s time to rethink eProcurement. Welcome to Tradeshift<sup>&reg;</sup> Buy.</strong></p>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="container">
					<div class="row">
						<div class="contents">
							...
							<p>Product Engine is the world’s first central, searchable product database. It spans millions of products across thousands of companies. Product Engine creates a full e-commerce experience for suppliers, buyers, and everyone in between – with your contracted prices and inventory.</p>
						...
						<div class="contents ">
							...
							<div class="video-demo hidden-xs SL_swap" id="ts-buy-bubble-swap">
								<div id="bubble-buy-sm" class="callout hidden-xs">
									...
									<!-- <div class="bubble-buy">Buy Anywhere uses browser extensions to track online purchasing. It then generates a single-use credit card in real-time to use at checkout.</div> -->
								</div>
					...
					<div class="row">
						<div class="contents">
							...
							<div class="collab-copy">
								<p>With Tradeshift Collaborate, your procurement team, suppliers, managers, and employees can chat and collaborate together within Tradeshift throughout the entire buying process.</p>
			...
			<div class="apps">
				<div class="container">
					<div class="row apps-expand">
						<div class="contents">
							<h2>Apps</h2>
							<h3>Expand your buying experience.</h3>
					...
					<div class="row">
						<div class="contents">
							...
							<div class="resource-wrapper">
								<a class="trigger-res-1" href="http://tradeshift.com/solutions/eprocurement/"><img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/img/solutions/buy/resources-procure.jpg" /></a>
								<p>Procurement Pains <br class="visible-sm" /><a class="trigger-res-1"  href="http://tradeshift.com/solutions/eprocurement/" onclick="_gaq.push(['_trackEvent', 'TS_buy', 'Click', 'res 1' ]);">Watch video &raquo;</a></p>
							</div>
							<div class="resource-wrapper">
		      ...
		      <div class="modal-body">
		        ...
		        MktoForms2.loadForm("//app-sjo.marketo.com", "213-SPR-003", 951, function(form){
		           ...
		           form.onSubmit(function(){
		              ga('send', 'event', 'Main CTA', 'Submit', 'Solutions - Tradeshift Buy', {nonInteraction: true});
		           });
		    	});
				// ]]></script>
		      </div>
