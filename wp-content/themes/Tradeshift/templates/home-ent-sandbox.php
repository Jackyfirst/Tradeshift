 <?php
/*
Template Name: Home Page - Enterprise v2 Sandbox
*/
get_header('home-ent'); ?>
		<!-- Main Content Starts -->
					...
					<div class="container">
						<div class="row cta">
							<div class="intro-text-cta">
								...
								<h1>Innovate the way <br class="visible-xs" />you <span class="text-carousel"> </span><span class="typed-cursor"> </span></h1>
