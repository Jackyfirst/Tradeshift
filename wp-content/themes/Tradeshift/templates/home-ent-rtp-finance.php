 <?php
/*
Template Name: Home Page - Enterprise RTP Finance
*/
get_header('home-ent'); ?>
		<!-- Main Content Starts -->
		<main class="main-content home-active">
			<!-- Hero Section -->
			<div id="heroEntHome" class="hero-finance">
				<div class="container">
					<div class="row cta">
						<div class="intro-text-cta">
							<h1>Finance, can you pass the disruption test?</h1>
							<h3>Get your financial services benchmark report. It’s a must if you want to produce real results.</h3>
							<a href="https://tradeshift.com/resources/financial-services-benchmark-report/" id="heroMainCtaEnterpriseHome" class="btn btn-primary-cta btn-white-secondary">Download your report</a>
						</div>
					</div>
				</div>
			</div>
