			...
			<div class="container">
				<div class="row">
					<div class="contents">
						...
						<p><?php _e("Oh nuts! Somehow the page you were looking for isn’t here. Maybe it’s someplace else, maybe it moved, or maybe it never existed.<br />We’re not saying anybody made a mistake— these things just happen sometimes.</p>", "Tradeshift") ?>
						<br /><br />
						<p class="white-space visible-md">&nbsp;<br />&nbsp;<br /></p>
						<p><strong><?php _e('A COUPLE OF PLACES WE CAN GO FROM HERE:</strong><br />
