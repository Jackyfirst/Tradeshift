 <?php
/*
Template Name: Home Page - Image
*/
get_header(); ?>
		<!-- Main Content Starts -->
		<main class="main-content home-active">
			<!-- Hero Section -->
			<div id="home-hero-a" class="hero one-supplier-image">
				<div class="container">
					<div class="row">
						<div  class="contents">
							<div class="intro-text-cta">
								<!-- Tagline ID serves as a landmark to toggle the promo banner view. Do not delete! -->
								<h1 id="tagline">All your suppliers.<br />All in one place.</h1>
								<h3>Simplify your supplier interactions with a platform built for business-to-business collaboration.</h3>
								<button class="btn btn-video-track btn-play-home visible-xs" onclick="fn_vidyard_8qM$xEdKhaI4R8gJC_3SYw();">Watch our story
								<script type="text/javascript" id="vidyard_embed_code_8qM-xEdKhaI4R8gJC_3SYw" src="//play.vidyard.com/8qM-xEdKhaI4R8gJC_3SYw.js?v=3.1&type=lightbox"></script></button>
								<div class="cta-buttons">
									<button class="btn btn-video-track btn-secondary-cta hidden-xs" onclick="fn_vidyard_8qM$xEdKhaI4R8gJC_3SYw(); _gaq.push(['_trackEvent', 'Main CTA', 'Click', 'Watch our story - header button' ]);">Watch our story</button>
									<button class="btn btn-primary-cta" onclick="_gaq.push(['_trackEvent', 'Main CTA', 'Click', 'Home - header button' ]);" data-toggle="modal" data-target="#mktoModal">Let's get started</button>
								</div>
							</div>
							<div class="persona hidden-xs">
								<button class="btn btn-video-track btn-play-home visible-md visible-lg" onclick="fn_vidyard_8qM$xEdKhaI4R8gJC_3SYw();">Watch our story</button>
								&nbsp;
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="contents">
							<div class="all-your-suppliers">
								<a href="http://tradeshift.com/supplier-onboarding/"><img src="<?php echo get_template_directory_uri(); ?>/img/icons/icon-odometer.png" /></a>
							...
							<div class="powerful-platform">
								<img src="<?php echo get_template_directory_uri(); ?>/img/icons/icon-platform.png" />
							...
							<div class="direct-indirect">
								<img src="<?php echo get_template_directory_uri(); ?>/img/icons/icon-dollar-sign.png" />
				...
				<div class="container">
					<div class="row">
						...
						<form novalidate autocomplete="off" class="roles-pages">
							...
							<div class="form-group">
								<button type="button" class="btn btn-primary-cta" id="submit" onclick="sameEmail(); _gaq.push(['_trackEvent', 'Main CTA', 'Click', 'Home Page - footer button' ]);" data-toggle="modal" data-target="#mktoModal">Let's get started</button>
							</div>
						</form>
					</div>
					<div class="row">
		      ...
		      <div class="modal-body">
		        ...
		        MktoForms2.loadForm("//app-sjo.marketo.com", "213-SPR-003", 656, function(form){
		           ...
		           form.onSubmit(function(){
		              _gaq.push(["_trackEvent", "Main CTA", "Submit", "Home page" ]);
		           });
		    	});
				// ]]></script>
		      </div>
		...
		<div id="promo" class="promo-banner" data-os-animation="fadeOutDown" data-os-animation-delay="0.5s" onclick="_gaq.push(['_trackEvent', 'Main CTA', 'Click', 'Home - banner' ]);">
			<div class="container">
				<div class="row">
					<div class="contents">
						...
						<?php foreach ($countries as $country) : ?>
							...
							<div class="promo-location-posts inactive" data-country="<?php echo $country; ?>">
								<?php while ($promo_query->have_posts()) : $promo_query->the_post(); ?>
									...
									?>
									<div id="promo-list" class="promo-wrapper <?php echo $promo_location_category->slug; ?> <?php echo $promo_type_category->slug; ?>">
										<a href="<?php echo $reg_link; ?>" target="_blank">
										<div class="listing">
											...
											<div class="cta"><a href="<?php echo $reg_link; ?>" target="_blank"><?php echo $reg_cta; ?> &raquo;</a></div>
										</div>
										</a>
									</div>
								<?php endwhile; ?>
