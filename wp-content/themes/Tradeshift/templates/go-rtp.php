 <?php
/*
Template Name: Go RTP - Landing Page
*/
get_header('go-rtp'); ?>
	<main id="fullpage" class="main-content ts-go-v2">
		<div class="section section-view section-one">
			<div class="container">
				<div class="row">
					<div class="contents">
						<div id="copyForm" class="copy-form-wrapper">
							<h2>Say hello to Go.<br />Your new virtual business assistant.</h2>
							<p>Managing company credit cards, travel, and expenses is complex. Go makes it surprisingly simple.</p>
							<script src="//app-sjo.marketo.com/js/forms2/js/forms2.min.js"></script>
							<?php if (!is_mobile()): ?>
							<div class="form-wrapper">
								<form id="mktoForm_1541" class="go-marketo-form"></form>
								<script type="text/javascript">// <![CDATA[
							        MktoForms2.loadForm("//app-sjo.marketo.com", "213-SPR-003", 1541, function(form){
		...
		<div class="section section-view section-two">
			<div class="container">
				<div class="row">
					<div class="contents">
						<div class="copy-form-wrapper">
							...
							<div class="form-wrapper">
								...
								<script type="text/javascript">// <![CDATA[
							        MktoForms2.loadForm("//app-sjo.marketo.com", "213-SPR-003", 1550, function(form){
							           form.vals({"Marketing_Resource_Name__c":"Go Page"});
							           form.onSubmit(function(){
							              var $mktoTSEmail = $('#Email').val();
							              analytics.alias(analytics.user().anonymousId());
		...
		<div class="section section-view section-three">
			<div class="container">
				<div class="row">
					<div class="contents">
						<div id="copyForm3" class="copy-form-wrapper">
							<h2>Try it with travel.<br>Oh, the places you'll Go.</h2>
							<p>Your smart new assistant can help you do other tasks too—starting with booking your next work trip. Book your flights, hotels, rental cars and restaurants simply by saying where you're headed: Go does the rest.</p>
		...
		<div class="section section-view section-four">
			<div class="container">
				<div class="row">
					<div class="contents">
						<h2>How it works:</h2>
		...
		<div class="section section-view section-five">
			<div class="container">
				<div class="row">
					<div class="contents">
						<div id="copyForm5" class="copy-form-wrapper">
							...
							<div class="form-wrapper">
								...
								<script type="text/javascript">// <![CDATA[
							        MktoForms2.loadForm("//app-sjo.marketo.com", "213-SPR-003", 1551, function(form){
							           form.vals({"Marketing_Resource_Name__c":"Go Page"});
							           form.onSubmit(function(){
							              var $mktoTSEmail = $('#Email').val();
							              analytics.alias(analytics.user().anonymousId());
		...
		<div class="section section-view section-six">
			<div class="container">
				<div class="row">
					<div class="contents">
						<div class="copy-form-wrapper">
							...
							<div class="form-wrapper">
								...
								<script type="text/javascript">// <![CDATA[
							        MktoForms2.loadForm("//app-sjo.marketo.com", "213-SPR-003", 1552, function(form){
							           form.vals({"Marketing_Resource_Name__c":"Go Page"});
							           form.onSubmit(function(){
							              var $mktoTSEmail = $('#Email').val();
							              analytics.alias(analytics.user().anonymousId());
	...
	<!-- Segment Analytics Tracking of each form -->
	<script>
		var form1 = document.getElementById('mktoForm_1541');
		analytics.trackForm(form1, 'Go Website Form Submit', {
		  formname: 'Email Field 1'
		});
		var form2 = document.getElementById('mktoForm_1550');
		analytics.trackForm(form2, 'Go Website Form Submit', {
		  formname: 'Email Field 2'
		});
		var form3 = document.getElementById('mktoForm_1496');
		analytics.trackForm(form3, 'Go Website Form Submit', {
		  formname: 'Phone Field 1'
		});
		var form4 = document.getElementById('mktoForm_1551');
		analytics.trackForm(form4, 'Go Website Form Submit', {
		  formname: 'Email Field 3'
		});
		var form5 = document.getElementById('mktoForm_1552');
		analytics.trackForm(form5, 'Go Website Form Submit', {
		  formname: 'Email Field 4'
		});
	</script>

<?php get_footer('go-rtp'); ?>
