<?php
/* Template Name: Landing Pages: Peppol 3
*/
get_header('difi'); ?>
...
<main class="main-content landing-pages lpv3 difi-2">
			...
			<div class="row">
				<div class="contents">
					<div>
						...
						<p>Når dere skal ta dette valget, er det viktig å huske på at vi hos Tradeshift allerede overholder kravene til PEPPOL og EHF, <strong>noe som i praksis betyr at din virksomhet allerede er klar for å samhandle elektronisk med deres forretningsforbindelser via PEPPOL-nettverket</strong>. Dette gjør at du kan fortsette å bruke PEPPOL-infrastrukturen uten å måtte endre på noe. Vi lanserer nå dessuten et nytt og spennende innkjøpssystem, som erstatter dagens IBX eOrder.</p>
						
						<h3>Hva er annerledes i den nye løsningen?</h3>
						<p>Den nye løsningen gjør søk og bestilling av varer og tjenester til en lek med minimalt av opplæring. I tillegg gir den nye løsningen full kontroll over arbeidsflyt og godkjenning, og har dessuten utvidet funksjonalitet for blant annet integrering av masterdata, kontoplan, og mulighet for integrasjon mot back-end systemer. Alt i alt er den nye løsningen lett å ta i bruk, krever lite opplæring og gir virksomheten en totalløsning for elektronisk handel som dere kan vokse med.</p>
						<p>Sist, men ikke minst: Ved å knytte seg til PEPPOL via Tradeshift får dere tilgang til et stort antall leverandører som allerede overholder kravene til PEPPOL og EHF samt at vi kan bidra med løsninger få å effektivt aktivere nye leverandører via PEPPOL og EHF. Tradeshift gjør det raskt og enkelt å finne dine leverandører og innlemme dem i prosessene dine.</p>
	...
	<div class="resources prefooter video">
		<div class="container">
			<div class="row">
				<?php if( !is_mobile() || !is_tablet() ): ?><div class="contents" style="padding-left: 0px !important"><?php else: ?>
				<div class="contents"><?php endif; ?>
					<h2>Hva er neste steg?</h2>
					<p>Her finner du en video som forklarer hvordan Tradeshift planlegger å jobbe videre fremover mot utløpet av Ehandelsplattform-avtalen. Hvis du vil ha mer informasjon, kan du ta kontakt for å avtale en prat om fremtidige innkjøp!</p>
					<div class="vid">
