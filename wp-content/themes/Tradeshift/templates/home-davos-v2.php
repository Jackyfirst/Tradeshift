 <?php
/*
Template Name: Home Page - Davos v2
*/
get_header('wec2016davos'); ?>
		<!-- Main Content Starts -->
		<main class="main-content home-active">
			<!-- Hero Section -->
			<div class="hero davos-live">
				<div class="container">
					<div class="row cta">
						<div class="contents">
							<div class="intro-text-cta">
								<img src="<?php echo get_template_directory_uri(); ?>/img/davos/ts-red-logo.png" alt="Tradeshift RED" class="ts-red-logo" />
								<h1><img src="<?php echo get_template_directory_uri(); ?>/img/davos/procured.png" alt="PROCU(RED)" /></h1>
								<h2>Buy for your company and make an impact.  See why we've partnered with (RED).</h2>
								<a href="/red"><button class="btn btn-primary-cta btn-white">Help end AIDS</button></a> <a href="/davos"><button class="btn btn-primary-cta">Visit Davos Live</button></a>
							</div>
						</div>
					</div>
				</div>
			...
			<div id="tagline-video" class="value-proposition">
				<!-- Tagline ID on div parent serves as a landmark to toggle the promo banner view. Do not delete! -->
				<div class="container">
					<div class="row">
						<div class="contents">
