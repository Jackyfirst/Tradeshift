 <?php
/*
Template Name: Home Page - Main v4
*/
get_header('main-only-v4'); ?>
...
<main id="fullpage" class="main-content home-main-v2">
  ...
  <?php endif; ?>
			<div class="ibx-banner hidden-xs">
				<div class="container">
					<p><img src="<?php echo get_template_directory_uri(); ?>/img/mainv2/ibx-logo.jpg" width="80" />Tradeshift acquires IBX Business Network <span>|</span> <span><a href="https://blog.tradeshift.com/weve-acquired-ibx-business-network-and-will-be-the-largest-business-commerce-platform-in-the-world">Learn more &raquo;</a></span></p>
				</div>
			</div>
			<div class="ibx-banner visible-xs">
				<div class="container">
					<div class="ibx-container">
						<a href="https://blog.tradeshift.com/weve-acquired-ibx-business-network-and-will-be-the-largest-business-commerce-platform-in-the-world"><img src="<?php echo get_template_directory_uri(); ?>/img/mainv2/ibx-logo.jpg" /></a>
						<p><a href="https://blog.tradeshift.com/weve-acquired-ibx-business-network-and-will-be-the-largest-business-commerce-platform-in-the-world">Tradeshift acquires IBX<br>Business Network</a></p>
          ...
          <button id="heroVideoTS_buy" class="btn btn-play-white" onclick="fn_vidyard_yLuLipN8zzvwaLn4w3TUg9();"> </button>
				...
				<div class="row">
					<div id="heroForm" class="form-container">
						<div id="formWrapper" class="form-wrapper" style="margin: auto;width: 100%;float: none;text-align: center;">
							<form id="mktoForm_1773" style="display: inline-block;"></form>
				...
				<div class="row">
					<div class="contents">
						...
						<div class="testimonials-wrapper visible-xs">
							<img src="<?php echo get_template_directory_uri(); ?>/img/mainv2/testimonials-xs-v3.jpg" class="visible-xs testimonials-xs" />
								...
								<div class="tiles tiles-wide tiles-flip" ontouchstart="this.classList.toggle('hover');">
									<div class="tiles-wrapper">
										...
										<div class="back back-wide">
											<img src="<?php echo get_template_directory_uri(); ?>/img/mainv2/tiles-hapag-lloyd.png" alt="Tradeshift’s platform ensures that something as simple as an invoice doesn’t slow down our 24/7 business, benefiting both our company and our suppliers. - Thierry Bellon, CPO, Air France-KLM" class="klm" />
										</div>
									</div>
								</div>
								...
								<div class="tiles tiles-sq" ontouchstart="this.classList.toggle('hover');">
									<div class="tiles-wrapper">
										...
										<div class="back">
											...
											<!-- <button class="btn btn-play-white" style="position: absolute;top: 0;left: 0;" onclick="fn_vidyard_yLuLipN8zzvwaLn4w3TUg9();"> </button> -->
										</div>
									</div>
								</div>
								<div class="tiles tiles-sq tiles-flip" ontouchstart="this.classList.toggle('hover');">
									<div class="tiles-wrapper">
										<div class="front">
											<img src="<?php echo get_template_directory_uri(); ?>/img/mainv2/tiles-zurich_2.png" />
										</div>
										<div class="back">
							...
							<div class="row">
								...
								<div class="tiles tiles-wide tiles-flip" ontouchstart="this.classList.toggle('hover');">
									<div class="tiles-wrapper">
										...
										<div class="back back-wide">
											<img src="<?php echo get_template_directory_uri(); ?>/img/mainv2/tiles-nhs-sbs-back.jpg" alt="Definitely recommended for NHS invoicing. I found it easy peasy to input my invoices, but the best thing was the speed of the approval process! - NHS supplier"  class="nhs-supplier"/>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="testimonials-wrapper visible-md visible-lg">
							...
							<div class="row">
								...
								<div class="tiles tiles-wide tiles-flip hapag-lloyd" ontouchstart="this.classList.toggle('hover');">
									<div class="tiles-wrapper">
										<div class="front front-wide">
											<img src="<?php echo get_template_directory_uri(); ?>/img/mainv2/tiles-hapag-lloyd.png" alt="Tradeshift’s interface is intuitive, state of the art, and among the best. The increase of transparency in workflows is one of major process improvements. - Dr. Thore Lindemann, Manager of e-Solutions, Hapag-Lloyd" class="hapag" />
										</div>
								...
								<div class="tiles tiles-sq tiles-flip visible-lg" ontouchstart="this.classList.toggle('hover');">
									<div class="tiles-wrapper">
										<div class="front">
											<img src="<?php echo get_template_directory_uri(); ?>/img/mainv2/tiles-zurich_2.png" style="width: 100%;height: 100%" />
										</div>
										<div class="back">
											<img src="<?php echo get_template_directory_uri(); ?>/img/mainv2/kuehne-nagel.jpg" />
										</div>
							...
							<div class="row lt-900">
								...
								<div class="tiles tiles-wide tiles-flip air-france" ontouchstart="this.classList.toggle('hover');">
									<div class="tiles-wrapper">
										<div class="front front-wide">
											<img src="<?php echo get_template_directory_uri(); ?>/img/mainv2/tile-airfrance-quote-front.jpg" alt="Tradeshift’s interface is intuitive, state of the art, and among the best. The increase of transparency in workflows is one of major process improvements. - Dr. Thore Lindemann, Manager of e-Solutions, Hapag-Lloyd" class="hapag" />
										</div>
										<div class="back back-wide">
											<img src="<?php echo get_template_directory_uri(); ?>/img/mainv2/UK-local-Gov-back.jpg" alt="Definitely recommended for NHS invoicing. I found it easy peasy to input my invoices, but the best thing was the speed of the approval process! - NHS supplier" class="nhs-supplier" />
										</div>
									</div>
								</div>
									...
									<div class="tiles-wrapper" style="transition: 2.5s;-webkit-transition: 2.5s;-moz-transition: 2.5s;">
										<div class="front front-wide" style="background: black">
											<img src="<?php echo get_template_directory_uri(); ?>/img/mainv2/tile-airfrance-front.jpg" alt="Tradeshift’s interface is intuitive, state of the art, and among the best. The increase of transparency in workflows is one of major process improvements. - Dr. Thore Lindemann, Manager of e-Solutions, Hapag-Lloyd" class="hapag" onclick="fn_vidyard_X26YsBw5CwzQGriGCdShtU();" style="cursor: pointer;"/>
												<!-- <div style="position: absolute;top: 50%;width:100%;top: 50%;transform: translateY(-50%);-ms-transform: translateY(-50%);margin-top: -14px"><button class="btn btn-play-white"  onclick="fn_vidyard_X26YsBw5CwzQGriGCdShtU();"> </button></div> -->
										</div>
										<div class="back back-wide">
