 <?php
/*
Template Name: Solutions - Tradeshift Risk New Gif
*/
get_header(); ?>
	...
	<main class="main-content ts-risk2">
				...
				<div class="row cta">
					<div class="contents">
						...
						<div class="content-wrapper">
							...
							<button class="btn btn-primary-cta btn-orange" onclick="_gaq.push(['_trackEvent', 'Main CTA', 'Click', 'Solutions - Tradeshift Risk - header button' ]);" data-toggle="modal" data-target="#mktoModal">Let's get started</button>
						</div>
					</div>
				</div>
				<?php if (is_mobile()): ?>
		...
		<div class="profiles" id="startOfProfiles">
			<div id="js-Sticky" class="container">
				...
				<div class="container">
					<div class="row">
						<div class="contents">
							...
							<div class="content-wrapper video-content" onclick="_gaq.push(['_trackEvent', 'TS_risk', 'Click', 'TS Risk Demo' ]);">
								<a onclick="fn_vidyard_bu6xm4QEzf3HmWVjmDY2Ag();"><img class="video-img" src="<?php echo get_template_directory_uri(); ?>/img/solutions/risk/watch-risk-demo.jpg" /></a>
								<!-- Vidyard script already embedded on the hero section -->
								<p>Tradeshift<sup>&reg;</sup> Risk<br class="visible-sm visible-md" /> Demo<br /><a onclick="fn_vidyard_bu6xm4QEzf3HmWVjmDY2Ag();">Play video &raquo;</a></p>
							</div>
							<div class="content-wrapper" onclick="_gaq.push(['_trackEvent', 'TS_risk', 'Click', 'Guide to Supplier Management' ]);">
								<a href="http://tradeshift.com/resources/essential-guide-to-supplier-management/"><img class="video-img" src="<?php echo get_template_directory_uri(); ?>/img/solutions/risk/read-guide.jpg" /></a>
								<p>Essential Guide to Supplier Management<br /><a href="http://tradeshift.com/resources/essential-guide-to-supplier-management/">Read more &raquo;</a></p>
							</div>
							<div class="content-wrapper" onclick="_gaq.push(['_trackEvent', 'TS_risk', 'Click', 'Supplier Management Checklist' ]);">
								<a href="http://tradeshift.com/resources/supplier-management-checklist/"><img class="video-img" src="<?php echo get_template_directory_uri(); ?>/img/solutions/risk/checklist.jpg" /></a>
								<p>Supplier Management Checklist<br /><a href="http://tradeshift.com/resources/supplier-management-checklist/">Check it out &raquo;</a></p>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="container">
				<div class="row">
					...
					<form novalidate autocomplete="off" class="roles-pages">
						...
						<div class="form-group">
							<button type="button" class="btn btn-primary-cta" id="submit" onclick="sameEmail(); _gaq.push(['_trackEvent', 'Main CTA', 'Click', 'Solutions - Tradeshift Buy - footer button' ]);" data-toggle="modal" data-target="#mktoModal">Let's get started</button>
						</div>
					</form>
				</div>
				<div class="row">
