 <?php
/*
Template Name: Home Page - Main v4 Solutions
*/
get_header('main-only-v4-solutions'); ?>
				...
				<div class="row">
					<div class="contents">
						...
						<div class="testimonials-wrapper visible-xs">
							<img src="<?php echo get_template_directory_uri(); ?>/img/mainv2/testimonials-xs-v2.jpg" class="visible-xs testimonials-xs" />
