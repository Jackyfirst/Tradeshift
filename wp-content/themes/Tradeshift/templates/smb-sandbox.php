 <?php
/*
Template Name: Roles - Small Business Sandbox
*/
get_header('smb2'); ?>
	<!-- Main Content Starts -->
					...
					<div class="cta-form hidden-xs">
						...
						<form id="smbForm" method="post">
							...
							<div class="form-group">
								<input name="url" id="url" type="text" tabindex="1" required="required" value="https://sandbox.tradeshift.com"/>
							</div>
							<div class="form-group">
								<input name="email" id="email" type="email" tabindex="2" required="required" placeholder="Email Address" data-default="Email"/>
							</div>
							<div class="form-group">
								<input name="companyName" id="companyName" type="text" tabindex="3" required="required" placeholder="Company Name"  />
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<input type="submit" tabindex="5" disabled="disabled" value="Send your first invoice" class="btn btn-primary-cta translate" onclick="_gaq.push(['_trackEvent', 'Main CTA', 'Click', 'SMB - header button' ]);" />
							</div>
						</form>
	...
	function getRegisterSubmitUrl() {
			...
			//	params['ajs_aid'] = analytics.user().anonymousId();
			// }

			var url = $('#url').val() + '/register/register';
	...
	$(document).ready(function() {
		...
		$('#smbForm').formValidation('revalidateField', 'url')
	...
	<script>
	  window.intercomSettings = {
	    app_id: "xd885ug2",
	    name: "Joe Shmoe", // Full name
	    email: "hardcoded.email@example.com", // Email address
	    created_at: 1312182000 // Signup date as a Unix timestamp
	  };
	</script>
	<script>(function(){var w=window;var ic=w.Intercom;if(typeof ic==="function"){ic('reattach_activator');ic('update',intercomSettings);}else{var d=document;var i=function(){i.c(arguments)};i.q=[];i.c=function(args){i.q.push(args)};w.Intercom=i;function l(){var s=d.createElement('script');s.type='text/javascript';s.async=true;s.src='https://widget.intercom.io/widget/rv5t8bg2';var x=d.getElementsByTagName('script')[0];x.parentNode.insertBefore(s,x);}if(w.attachEvent){w.attachEvent('onload',l);}else{w.addEventListener('load',l,false);}}})()</script>
