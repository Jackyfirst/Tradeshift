<?php
/* Template Name: Landing Pages: PPC v3
*/
get_header('lpv3'); ?>
				...
				<div class="row">
					<div class="contents">
						<div class="description">
							<h2>Tradeshift Value Estimator</h2>
							<h3>Business Case &amp; ROI Calculator</h3>
							<p>Use this quick and easy value estimator for eProcurement, Accounts Payable and Supplier Management. After entering a few basic inputs, based on your area of interest we will provide a free business case and summary highlighting your organization's details and the available value that the Tradeshift platform and solutions can generate.</p>
							<a href="/shift-your-value" class="btn btn-primary-cta hidden-xs" style="background: #ff9000 !important">Get started with the Tradeshift Value Estimator</a>
							<a href="/shift-your-value" class="btn btn-primary-cta visible-xs" style="background: #ff9000 !important">Get started with the Value Estimator</a>
							<img src="<?php echo get_template_directory_uri(); ?>/img/ppc-value-estimator-ipad.png" class="ipad-img img-responsive visible-sm visible-xs" />
						</div>
						<div class="ipad visible-lg visible-md">
							<img src="<?php echo get_template_directory_uri(); ?>/img/ppc-value-estimator-ipad.png" />
						</div>
					</div>
				</div>
			</div>
