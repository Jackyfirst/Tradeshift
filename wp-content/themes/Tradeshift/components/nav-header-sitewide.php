        ...
        <div class="row">
            <div class="site-navbar">
                ...
                <ul class="sign-up-login nav pull-right hidden-xs">
                    ...
                    <li id="demo" class="demo-request SL_swap"><button id="menuRequestDemo" class="btn btn-request-demo-ent main-header-nav-links" data-toggle="modal" data-target="#mktoDemo">Request a Demo</button></li>
                </ul>
            </div>
            <nav class="main-nav-wrapper">
                <ul class="main-nav">
