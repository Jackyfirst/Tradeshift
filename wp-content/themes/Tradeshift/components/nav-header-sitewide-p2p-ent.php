   <?php
/**
 * This component serves as the Sitewide Navigation for Procure to pay Page
 *
 * @package wpbc_s
 */
?>
        ...
        <div class="container">
            <div class="row sub-nav-enterprise">
                ...
                <div class="ent-nav-wrapper">
                    ...
                    <h3><a href="/enterprise/solutions/procure-to-pay/" class="main-header-nav-links">Manage all aspects of your procure-to-pay process through simplified solutions</a></h3>
                </div>
            </div>
