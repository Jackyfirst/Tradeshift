                ...
                <ul class="main-nav">
                    <li class="nav-list"><a id="ent-trigger" href="#" class="subnav-trigger">Solutions</a>
                        ...
                        <ul class="ent-subnav">
                            ...
                            <li><a href="/enterprise/resources/" class="main-header-nav-links">Resource Center</a></li>
                        </ul>
                    </li>
                    <li class="nav-list">
                ...
                <div class="login-nav">
                    ...
                    <div id="navMainRow" class="main-nav-row">
                        <ul class="main-nav-list">
                            ...
                            <li id="main-nav-link-go" class="sub-nav-list"><a class="main-nav-go main-header-nav-links" href="//tradeshift.com/go/">For SMB</a></li>
