...
WeakMap = this.WeakMap || this.MozWeakMap ||
    (WeakMap = (function() {
            function WeakMap() {
              this.keys = [];
              this.values = [];
...
this.WOW = (function() {
  ...
  WOW.prototype.resetAnimation = function(event) {
    ...
    if (event.type.toLowerCase().indexOf('animationend') >= 0) {
      ...
      return target.className =
                 target.className.replace(this.config.animateClass, '').trim();
    }
  };
  ...
  WOW.prototype.isVisible = function(box) {
    ...
    viewTop = (this.config.scrollContainer &&
        ...
        window.pageYOffset;
    viewBottom = viewTop +
        Math.min(this.element.clientHeight, this.util().innerHeight()) - offset;
