...
;(function(window) {
	...
	Calendar.prototype._showPreviewTitle = function(text, number) {
		...
		this.dayPreview.setAttribute('data-number', parseInt(number+13)); //modified to match oour calendar
	...
	Calendar.prototype._changeBGColor = function(color) {
		//document.getElementsByClassName("header-sitewide-lp").style.backgroundColor = '#000';
		//document.getElementById("myHeader").style.backgroundColor = "black";
		//bgEl.style.backgroundColor = color; // changes color on hover
	...
	Snow.prototype._init = function() {
		...
		window.addEventListener('resize', function() {
			...
			self.height = self.canvas.height = window.innerHeight + 65;
		});
...
window.onload = function() {
    ...
    $('.cube').click(function() {
    	...
    	if($('.cube').index(this) == 0 || $('.cube').index(this) == 2 || $('.cube').index(this) == 4 || $('.cube').index(this) == 6 || $('.cube').index(this) == 8 || $('.cube').index(this) == 10 ) {
    		$('main.main-content').stop(true,false).removeAttr('style').addClass('red', {duration:800});
    	
    	// } else if($('.cube').index(this) == 12) {
    	// 	$('.calendar-wrap .content').stop(true,false).removeAttr('style').addClass('p2p_wonderland', {duration:800});
    	// }
    	} else if($('.cube').index(this) == 12) {
    		$('main.main-content').stop(true,false).removeAttr('style').addClass('p2p_wonderland', {duration:800});
    	}
    	else {
    		$('main.main-content').stop(true,false).removeAttr('style').addClass('blue', {duration:800});
    	}

    	//$('.content__block').stop(true,false).removeAttr('style').addClass('show_content', {duration:800});
    });

    $('button.btn-back').click(function() {
    	$('main.main-content').stop(true,false).removeClass( "red blue p2p_wonderland", 800, "easeInBack" );
    });
    ...
    function imageresize() {
		...
		if ((contentwidth) < '768'){
			//13
			$('.imageclass_13').attr('src','/wp-content/themes/Tradeshift/img/holiday-2016/holiday2016-reindeer_small.png');
			//16
			$('.imageclass_16').attr('src','/wp-content/themes/Tradeshift/img/holiday-2016/holiday2016-watch_small.png');
			//17
			$('.imageclass_17').attr('src','/wp-content/themes/Tradeshift/img/holiday-2016/holiday2016-cups_small.png');
			//21
			$('.imageclass_21').attr('src','/wp-content/themes/Tradeshift/img/holiday-2016/holiday2016-leapfrog_small.png');
			//22
			$('.imageclass_22').attr('src','/wp-content/themes/Tradeshift/img/holiday-2016/holiday2016-beanie_small.png');
			//24
			$('.imageclass_24').attr('src','/wp-content/themes/Tradeshift/img/holiday-2016/holiday2016-chocolate_small.png');


		} else {
			//13
			$('.imageclass_13').attr('src','/wp-content/themes/Tradeshift/img/holiday-2016/holiday2016-reindeer.png');
			//16
			$('.imageclass_16').attr('src','/wp-content/themes/Tradeshift/img/holiday-2016/holiday2016-watch.png');
			//17
			$('.imageclass_17').attr('src','/wp-content/themes/Tradeshift/img/holiday-2016/holiday2016-cups.png');
			//21
			$('.imageclass_21').attr('src','/wp-content/themes/Tradeshift/img/holiday-2016/holiday2016-leapfrog.png');
			//22
			$('.imageclass_22').attr('src','/wp-content/themes/Tradeshift/img/holiday-2016/holiday2016-beanie.png');
			//24
			$('.imageclass_24').attr('src','/wp-content/themes/Tradeshift/img/holiday-2016/holiday2016-chocolate.png');
